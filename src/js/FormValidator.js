    ...
    checkInputValidity(event) {
      ...
      if (!(inputElem.checkValidity())) {
        if (inputElem.validity.valueMissing) {
          errorMessage = Script.validationMessages.validationValueMissing;
        } else if (inputElem.validity.tooShort) {
          errorMessage = Script.validationMessages.validationLenghtErr;
        } else if (inputElem.validity.patternMismatch) {
          errorMessage = Script.validationMessages.validationNotUrl;
        }
